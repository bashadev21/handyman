...
class ProviderListResponse {
  ...
  ProviderListResponse({this.pagination, this.provider});

  ProviderListResponse.fromJson(Map<String, dynamic> json) {
    pagination = json['pagination'] != null ? new Pagination.fromJson(json['pagination']) : null;
    if (json['data'] != null) {
      provider = json['data'] != null ? (json['data'] as List).map((i) => ProviderData.fromJson(i)).toList() : null;
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.provider != null) {
      data['data'] = this.provider!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
